...
public class PrimarySkill : BaseSkillState
{
    ...
    public override void OnEnter()
    {
        ...
        base.characterBody.StartCoroutine(this.FireArrow());
    ...
    private IEnumerator FireArrow()
    {
        ...
        }else
        {
            ...
            for (int i = 0; i < 1000; ++i)
            {
                ...
                if ((this.AniviaHandler.iceBallTravelDistance() < this.maxDistance) && (this.AniviaHandler.hasQ()))
    ...
    public override void FixedUpdate()
    {
        ...
        if ((base.fixedAge >= this.duration && base.isAuthority) || this.maxRange)
        {
